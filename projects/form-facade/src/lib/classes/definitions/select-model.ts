...
export class SelectManager {
    ...
    get selectedId(): string | null {
        if (this.multiple) throw new Error('Cannot get selectedId with a multiple select');
    ...
    set selectedId(id: string | null) {
        if (this.multiple) throw new Error('Cannot set selectedId with a multiple select');
